...
cd $ROOT_DIR
python -m tools.main --config configs/HIM/mgm_dec-embed-atten_him_short-768-512x512_bs8_50k_adamw_2e-4.yaml --override --dist --gpus 4 \
                    name mgm_him_dec-embed_no-inst-loss_max-3-inst_bs12_30k_adamw_2.0e-4 \
