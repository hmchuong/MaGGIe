...
cd $ROOT_DIR
python -m tools.main --config configs/HHM/vm2m0711_hhm_short-768-512x512_bs32_50k_adamw_2e-4.yaml --override --dist --gpus 4 train.batch_size 64 #name debug train.log_iter 10
