...
def build_dataset(cfg, is_train=True, random_seed=0):
    if cfg.name in ["VideoMatte240K", "polarized_matting"]:
        ...
        if is_train:
            ...
            dataset = HIMDataset(root_dir=cfg.root_dir, split=cfg.split, short_size=cfg.short_size, is_train=is_train, downscale_mask=cfg.downscale_mask, alpha_dir_name=cfg.alpha_dir_name)
