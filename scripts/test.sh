...
CUDA_VISIBLE_DEVICES=0 python -m tools.main --config /home/chuongh/vm2m/output/baseline_rn34_0614/config.yaml --eval-only \
        name baseline_rn34_0614 \
        model.weights output/VideoMatte240K/vm2m_vid240_pre-hmm_s-768-512x512_b4-f8_100k_adamw_1e-4/best_model.pth \
        dataset.test.split test \
        test.save_results False \
        test.postprocessing True \
        test.save_dir /home/chuongh/vm2m/output/vm2m_vid240_pre-hmm_s-768-512x512_b4-f8_100k_adamw_1e-4/vis_test