...
# CONFIG=configs/HIM/ours_1031_singlestage.yaml
# NAME=ours_1031_single-stage
# torchrun --standalone --nproc_per_node=8  tools/main_ddp.py \
#                     --config $CONFIG --precision 16 name $NAME train.max_iter 52000 train.batch_size 12 wandb.id 7peb9mez
