...
NAME=ours_1106_single-stage_stronger-aug_ft #_random-crop
...
torchrun $PYCMD tools/main_ddp.py \
                    ...
                    model.mgm.warmup_iter 0 model.decoder_args.warmup_detail_iter 0 model.freeze_coarse True train.optimizer.lr 0.00005
