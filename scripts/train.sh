...
DEBUG=1 python -m tools.main --config configs/HHM/mgmdk_8x8_hhm_short-768-512x512_bs32_50k_adamw_2e-4.yaml --gpus 4 name debug wandb.use False train.log_iter 1 train.batch_size 16