...
python -m tools.main --config configs/HHM/vm2m_short-768-512x512_bs16_100k_adamw_2e-4.yaml --override --gpus 4 name debug train.val_iter 100 train.log_iter 10 train.vis_iter 50 train.num_workers 4