...
do
    ...
    do
    python -m tools.main --dist --gpus 4 --dist-url tcp://127.0.0.1:$1 --config output/HIM/ours_1102_single-stage_strong-aug/config.yaml --eval-only \
                                                    model.weights output/HIM/ours_1102_single-stage_strong-aug/last_model.pth \
