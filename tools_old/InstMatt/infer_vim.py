...
if __name__ == '__main__':
    ...
    for image_path in tqdm.tqdm(image_list):
        ...
        mask_paths = list(glob.glob(os.path.join(args.mask_dir, video_name, os.path.basename(image_path).replace('.jpg', '')) + '/*.png'))
        ...
        output_dir = os.path.join(args.output, video_name, os.path.basename(image_path).replace('.jpg', ''))
