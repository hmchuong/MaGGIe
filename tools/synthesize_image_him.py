...
if __name__ == "__main__":
    ...
    parser.add_argument('--invalid-names', type=str, default='invalid_him.txt')
    parser.add_argument('--max-num-images', type=int, default=50000)
    parser.add_argument('--output_dir', type=str)
    parser.add_argument('--bg-root', type=str)
    ...
    invalid_names = set()
    with open(args.invalid_names, 'r') as f:
    ...
    os.makedirs(fg_output_dir, exist_ok=True)

    # Generate images
    num_images = args.max_num_images
